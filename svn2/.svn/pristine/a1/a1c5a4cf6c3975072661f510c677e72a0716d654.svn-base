...
public class PayController {
    ...
    @RequestMapping("/prePay/{id}")
    public String prePay(Model model,@PathVariable("id")Integer id) throws ParseException {
        List<BookMessage> bookMessageList = bookMessageService.findAllByAuthor(id);
