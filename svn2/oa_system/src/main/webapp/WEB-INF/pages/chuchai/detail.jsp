...
<div class="container-fluid">
    ...
    <div class="col-md-10">
        <form action="" method="post" id="frm1">
            <input type="hidden" name="id" value="${chuChai.id}">
            <input type="hidden" name="processId" value="${chuChai.processId}">
            <table class="table table-bordered">
                <caption>出差详情</caption>
                <tr>
                    <td>出差事由：</td>
...
<script type="text/javascript">
    function fnCheck(n) {
        ...
        if (n == 1){
            frm.action = "chuchai/agree";
            frm.submit();
        }else if (n == 2){
            frm.action = "chuchai/disAgree";
            frm.submit();
        }else{
